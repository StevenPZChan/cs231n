...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        h2, cache2 = affine_relu_forward(h1.reshape(X.shape[0], -1), W2, b2)
        ...
        loss += self.reg * sum(1 / 2 * (w ** 2).sum() for w in [W1, W2, W3])
        dh2, grads['W3'], grads['b3'] = affine_backward(dy, cache3)
        dh1, grads['W2'], grads['b2'] = affine_relu_backward(dh2, cache2)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dh1.reshape(h1.shape), cache1)
